...
<template>
    <GuestLayout>
        ...
        <div class="mt-4 text-center">
            ...
            <Link :href="route('register')" class="text-sm text-[#40D5C8] hover:underline font-semibold">
                Daftar sekarang
            </Link>
        </div>
        ...
        <div class="flex items-center gap-4 py-6 w-full">
            ...
            <span class="text-slate-400 text-sm font-medium">atau masuk dengan email</span>
            <div class="h-[1px] flex-1 bg-slate-200"></div>
        </div>
            ...
            <div class="mt-6 flex flex-col gap-4">
                ...
                <div class="flex items-center justify-center">
                    <Link
                        ...
                        class="rounded-md text-sm text-slate-500 hover:text-slate-900 focus:outline-none focus:ring-2 focus:ring-[#40D5C8] focus:ring-offset-2 transition-colors"
                    >
